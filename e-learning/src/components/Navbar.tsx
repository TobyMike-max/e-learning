  ...
  return (
	  ...
	  <div className="flex flex-row justify-between items-center">
		  <div className="flex justify-between basis-2/6">
			  { !isMenuOpen && <HamburgerIcon onClick={toggleMenu} isOpen={isMenuOpen} /> }
	  ...
	  />
		<ExpandMoreOutlinedIcon onClick={handleClick} style={{ position: 'relative' }} />
		<div className={`bg-[white] absolute left-200 top-8 ${isArrowOpen ? 'block' : 'hidden'}`}>
			<p>Profile</p>
